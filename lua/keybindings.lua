...
vim.keymap.set("n", "<leader>do", function() require("dap").open() end, opt)
...
vim.keymap.set("n", "<leader>as", "<cmd>ClaudeCodeTreeAdd<cr>", { desc = "Add file (filetree)" })
